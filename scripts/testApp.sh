...
RESPONSE=$(curl --no-progress-meter -k --user bob:bobpwd -X POST 'https://localhost:9443/inventory/api/systems/client/localhost')
echo "$RESPONSE" | grep "was added" || exit 1
