...
curl -k -X POST "https://localhost:9080/dev/api/systems?heapSize=1048576&hostname=localhost&javaVersion=9&osName=linux" | grep "added" || exit 1
curl -k "https://localhost:9080/dev/api/systems" | grep "localhost" || exit 1
