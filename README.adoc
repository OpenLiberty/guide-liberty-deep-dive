...
The [hotspot=quiqckStartSec file=0]`quickStartSecurity` tag will enable security for the `/metrics` endpoint and allow you to log in with the credentials defined.
