...
You can check that the system service is secured against unauthenticated requests by visiting to the https://localhost:9444/system/api/heapsize system endpoint in your browser. You should expect to see the following error at the console of running the `system` microservice:
