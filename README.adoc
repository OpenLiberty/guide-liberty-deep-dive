...
`src/main/java/io/openliberty/deepdive/rest/liberty/config/server.xml`
----
server.xml
[source, Java, linenums, role='code_column hide_tags=copyright']
----
include::finish/module-getting-started/src/main/java/io/openliberty/deepdive/rest/liberty/config/server.xml[]
----
