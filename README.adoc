...
This application is configured to be built with Maven. Every Maven-configured project contains a `settings.gradle` and a `build.gradle` file that defines the project configuration, dependencies, and plug-ins.
