...
In this workshop, the Open Liberty Starter is used to create the starting point of the application. Gradle is used as the selected build tool and the application uses of Jakarta EE 9.1 and MicroProfile 5.
...
* update [hotspot=contextRoot file=1]`liberty.server.var.'app.context.root'` to `/trial`.
