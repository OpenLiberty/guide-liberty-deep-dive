...
```bash
curl -X PUT 'http://localhost:9090/inventory/api/systems/localhost?heapSize=2097152&javaVersion=17&osName=linux'
```
...
[role='command']
----
curl -X POST 'http://localhost:9090/inventory/api/systems?hostname=localhost&osName=mac&javaVersion=17&heapSize=1'
----
...
curl -k --user alice:alicepwd -X PUT \
  'http://localhost:9090/inventory/api/systems/localhost?heapSize=2097152&javaVersion=17&osName=linux'
```
...
Make the `pom.xml` configuraton file.

[role='code_command hotspot file=0', subs="quotes"]
----
#Replace the Liberty `pom.xml` configuraton file.#
`pom.xml`
----
...
[source, xml, linenums, role='code_column hide_tags=copyright']
----
include::finish/module-kubernetes/pom.xml[]
----
...
[role="code_command hotspot file=6", subs="quotes"]
----
...
[source, xml, linenums, role='code_column hide_tags=copyright']
----
include::finish/module-testcontainers/src/main/liberty/config/server.xml[]
----
...
```bash
curl -k --user alice:alicepwd -X PUT \
  'https://localhost:9453/inventory/api/systems/localhost?heapSize=2097152&javaVersion=17&osName=linux'
```
...
```bash
curl -k --user alice:alicepwd -X PUT \
  'https://localhost:9453/dev/api/systems/localhost?heapSize=2097152&javaVersion=17&osName=linux'
```
