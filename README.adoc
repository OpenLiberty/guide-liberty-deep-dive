...
Press CTRL+C in the session that the dev mode `mvn liberty:dev` was started in the previous section. Navigate to your application directory if you are not:
