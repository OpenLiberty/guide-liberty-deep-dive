...
Similarly, a Kubernetes resource definition is provided in the [hotspot file=1]`postgres.yaml` file at the `start/postgres` directory. In the `postgres.yaml` file, the deployment for the PostgresSQL database is defined. 
