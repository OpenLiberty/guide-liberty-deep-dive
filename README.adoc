...
:page-releasedate: 2022, 2023-04-27
...
The [hotspot=from file=0]`FROM` instruction initializes a new build stage and indicates the parent image from which your image is built. In this case, you’re using the `icr.io/appcafe/open-liberty:kernel-slim-java11-openj9-ubi` image that comes with the latest Open Liberty runtime as your parent image.
