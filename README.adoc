...
First, in order to be able to utilise MicroProfile OpenAPI, the server.xml must be updated to include it:

[role="code_command hotspot file=0", subs="quotes"]
----
#Update the `server.xml` file.#
`src/main/java/io/openliberty/guides/inventory/liberty/config/server.xml`
----
server.xml
[source, Java, linenums, role='code_column hide_tags=copyright']
----
include::finish/module-openapi/src/main/java/io/openliberty/guides/inventory/liberty/config/server.xml[]
----


=== Build the application using dev mode

Now that the server.xml file has been updated, the application needs to be rebuilt. Use Open Liberty's dev mofde for this so that it picks up the changes you will make next automatically.
...
[source, Java, linenums, role='code_column hide_tags=copyright']
----
include::finish/module-openapi/src/main/java/io/openliberty/guides/inventory/SystemResource.java[]
----
...
[hotspot=InventoryListClass file=1]`Inventory` POJO and hence it's very difficult to tell 
exactly what that POJO is used for. 
To describe the [hotspot=InventoryClass file=2]`Inventory` POJO in more detail, 
augment the [hotspot file=2]`src/main/java/io/openliberty/guides/inventory/Inventory.java` 
...
`src/main/java/io/openliberty/guides/inventory/Inventory.java`
----
Inventory.java
[source, Java, linenums, role='code_column hide_tags=copyright']
----
include::finish/module-openapi/src/main/java/io/openliberty/guides/inventory/Inventory.java[]
----
...
[source, Java, linenums, role='code_column hide_tags=copyright']
----
include::finish/module-openapi/src/main/java/io/openliberty/guides/inventory/model/SystemData.java[]
----
