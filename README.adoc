...
Apply the [hotspot=MetricsAddNew file=1]`@Counted` annotation to each of the endpoints to count the invocations of the annotated object in this case the calls to our REST API.
