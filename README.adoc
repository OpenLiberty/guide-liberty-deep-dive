...
You can check out the service at the https://localhost:31000/openapi/ui/[https://localhost:31000/openapi/ui/^] URL.  The servers dropdown list should show the `https://localhost:31000/dev`. You can run the following command to access the inventory microservice:
[role='command']
```
