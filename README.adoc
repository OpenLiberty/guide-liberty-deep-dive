...
[source, yaml, linenums, role='code_column']
----
include::finish/module-kubernetes/postgres.yaml[]
----

[role="code_command hotspot file=0",subs="quotes"]
----
#Create the `inventory.init.yaml` in the `start/module-kubernetes` directory.#
`inventory.init.yaml`
----
...
[role='command']
```
kubectl delete --force -f inventory.init.yaml
kubectl apply --force -f inventory.yaml
```
