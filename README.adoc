...
Then select the `Generate Project` button. This will download the starter project as a .zip file. 

Next, unpackage the .zip file on your machine. Move the contents of this unzipped `liberty-deepdive-inventory` directory to within the start directory of this project.
