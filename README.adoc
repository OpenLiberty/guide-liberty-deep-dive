...
So far you've been using hard-coded values to set the HTTP and HTTPS ports, as well as the context root. Now, configuration will be added to be able to change these values. 
