...
You can check that the system service is secured against unauthenticated requests by going to the https://localhost:9444/system/api/heapSize system endpoint in your browser.
