...
Create the `model` subdirectory before creating the `SystemData` class. The `SystemData` class is a POJO (Plain Old Java Object) that represents a single inventory entry. 
