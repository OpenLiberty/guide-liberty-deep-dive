...
`src/main/java/io/openliberty/deepdive/rest/health/SystemLivenessCheck.java`
----
...
----
include::finish/module-health-checks/src/main/java/io/openliberty/deepdive/rest/health/SystemReadinessCheck.java[]
----
