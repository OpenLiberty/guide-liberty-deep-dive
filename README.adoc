...
* [hotspot=httpPort file=1]`liberty.var.http.port` to `9091`
* [hotspot=httpsPort file=1]`liberty.var.https.port` to `9455`
...
* update [hotspot=httpPort file=1]`liberty.var.http.port` to `9090`
* update [hotspot=httpsPort file=1]`liberty.var.https.port` to `9453`
* update [hotspot=contextRoot file=1]`liberty.var.context.root` to `/inventory`.
